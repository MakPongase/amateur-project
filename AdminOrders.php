...
<head>
    ...
    <link rel="stylesheet" href="CSS/OrdersAdminPage.css">
                            ...
                            <tr class="action-row">
                                <td colspan="4" class="action-buttons">
                                    <?php if ($order_status == 'Pending'): ?>
                                        <form method="POST" action="PHP/UpdateOrderStatus.php">
                                            <input type="hidden" name="order_id" value="<?php echo $order['OrderID']; ?>">
                                            <button type="submit" name="action" value="Ship" class="on-the-way">Ship</button>
